...
final class TargetBoundStateCleanupService {
    ...
    func purgeStaleState(repositoryPath: String, currentTarget: String) {
        ...
        let candidatePaths = [
            ".local/state/jackrose/install/current/install-target.json",
            ".local/state/jackrose/install/current/last-plan.json",
            ".local/state/jackrose/install/current/last-result.json",
            ".local/state/jackrose/mutation/current/disposable-target.json",
            ".local/state/jackrose/mutation/current/last-plan.json",
            ".local/state/jackrose/mutation/current/last-execution.json",
            ".local/state/jackrose/mutation/current/last-verification.json",
            ".local/state/jackrose/boot-safety/current/gate-evaluate-controlled-install.json",
        ]
