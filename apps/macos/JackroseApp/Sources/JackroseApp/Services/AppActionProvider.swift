...
class AppActionProvider {
    ...
    func getActions(category: String? = nil) -> [AppAction] {
        ...
        let actions = seed?.actions ?? [
            ...
            AppAction(id: "uninstall-scan", title: "Scan Deletion Targets", category: "uninstall", command: "scripts/jackrose-uninstall-target-scan --json", safeToRun: true, requiresPrivilege: false, destructive: false)
        ]
