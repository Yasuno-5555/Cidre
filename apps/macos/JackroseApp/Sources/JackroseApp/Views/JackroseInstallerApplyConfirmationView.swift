...
public struct JackroseInstallerApplyConfirmationView: View {
    @State private var confirmationInput: String = ""
    let onApply: (String) -> Void
    
    private let expectedString = "APPLY JACKROSE STAGING TO SELECTED TARGET"
    ...
    public var body: some View {
        VStack(alignment: .leading, spacing: 20) {
            ...
            Text("This will write the validated Jackrose rootfs files directly to the selected target partition.")
                .font(.body)
