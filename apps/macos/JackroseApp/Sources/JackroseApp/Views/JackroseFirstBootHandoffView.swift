...
public struct JackroseFirstBootHandoffView: View {
    ...
    public var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            HStack(spacing: 12) {
                ...
                Text("Jackrose Staging Completed Successfully")
                    .font(.title2)
                    .bold()
            }
            ...
            Group {
                ...
                Text("- Select the newly staged Jackrose partition target from the Startup Options menu manually.")
                Text("- Jackrose first boot will automatically launch the desktop-first Welcome configuration wizard.")
            }
