...
public struct JackroseInstallPlan: Codable {
...
public struct StagedTargetValidation: Codable {
    public struct RootfsPaths: Codable {
        ...
        public let etc: Bool
        public let `var`: Bool
        public let usr_share_jackrose_defaults: Bool
    }
    
    public struct JackroseComponents: Codable {
        public let jackrose_welcome: Bool
        public let jackrose_doctor: Bool
        public let jackrose_session: Bool
    }
    ...
    public let jackrose_components: JackroseComponents
