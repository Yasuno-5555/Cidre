    ...
    func operations(for mode: WizardMode) -> [WizardOperation] {
        ...
        case .install:
            return [
                ...
                WizardOperation(id: "install-plan", title: "Build install plan", category: "setup", stage: .installPlan, privilegeLevel: .none, destructive: false, requiresConfirmation: false, requiresHelper: false, dryRunAvailable: false, command: "scripts/cidre-app-wizard-plan --mode install --json", rollbackHint: nil),
