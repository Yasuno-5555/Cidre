...
- Purpose: move Rescue Slot from foundation toward real boot integration planning
- Scope: metadata, dry-run planning, disk audit, guide, checklist, validation recording
- v0.27.0 stays read-only and dry-run first
