...
The `jackrose-compat-cidre` package is intended as a temporary migration aid and may be removed before the Jackrose 1.0 release.
- **v0.38.x**: Compatibility enabled, warning only.
- **v0.39.x**: Stronger deprecation warnings.
- **v0.40.x / v1.0**: Compatibility package made optional and removed from default installs.
