# Jackrose to Asahi/ALARM Installer Data Fields Mappings

## Summary
The fields mappings summarize how Jackrose installer-facing JSON translates into upstream Asahi/ALARM installer definitions.

| Jackrose field | Installer-facing field | Asahi/ALARM field | Mapping status | Notes |
|---|---|---|---|---|
...
- `images[].manifest` ==> `os_list[].manifest` (Direct/Jackrose Extension)
- `images[].first_boot_mode` ==> `os_list[].first_boot_mode` (Jackrose Extension)
