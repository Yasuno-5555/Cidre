#!/bin/bash
set -eu
# cidre-fix-bootability.sh
# Fixes Cidre bootability: fsctl bootable flag + missing files + bless.
# MUST be run with sudo: sudo bash cidre-fix-bootability.sh
#
...
echo "=== Cidre Bootability Fix ==="
echo ""

VGID="79209CAB-9676-45C9-BE84-F75E181BFAB3"
SYSTEM_DEV="disk3s2"
SYSTEM_MOUNT="/Volumes/Cidre 1"
...
echo "[3/5] Copying PlatformSupport.plist to Cidre CoreServices..."
...
echo "[4/5] Verifying Cidre boot structure..."
echo "  CoreServices:"
...
echo "  2. Mac should boot into Cidre (1TR mode)"
echo "  3. Utilities → Terminal → /Volumes/Cidre/cidre-step2.sh"
echo "  4. After step2 + reboot, Cidre shows in boot picker"
echo "============================================"
